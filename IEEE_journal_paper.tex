...
\[
\Delta R_{\text{rt}}\rBrace{\omega}=\frac{\dPhi\lambda}{2\pi} 
\]
...
\par Future study of the FB concept may be applied to other array processing applications other than localization, inspect other interesting choices of coefficient rather than the DS generalization, suggest other waveforms and associated processing schemes, extend the results to dynamic/multiple targets, consider sensors with general radiation patterns etc.
