...
\begin{figure}[t!]
   ...
   \subfloat[][]{\begin{overpic}[width=.45\linewidth, 
        % grid, 
        tics=10,trim=0 0 0 0]{./Media/h_thetaTau/spatialIIR_amb_N3r04.png}
            \put (12, 73.5){\tiny{$\lBrace{h\rBrace{\dTheta,\dPhi}}_{\vBrace{dB}}, r=0.4$}}
            \put (47.5, -1) {\tiny{$\dTheta/\pi$}}
            \put (-3, 38) {\tiny{$\dPhi/\pi$}}
        \end{overpic}\label{subfig_hDUDTContour_r04}}\quad
    \subfloat[][]{\begin{overpic}[width=.45\linewidth, 
        % grid, 
        tics=10,trim=0 0 0 0]{./Media/h_thetaTau/spatialIIR_amb_N3r06.png}
            \put (12, 73.5){\tiny{$\lBrace{h\rBrace{\dTheta,\dPhi}}_{\vBrace{dB}}, r=0.6$}}
            \put (47.5, -1) {\tiny{$\dTheta/\pi$}}
            \put (-3, 38) {\tiny{$\dPhi/\pi$}}
        \end{overpic}\label{subfig_hDUDTContour_r06}}\\
   \subfloat[][]{\begin{overpic}[width=.45\linewidth, 
        % grid, 
        tics=10,trim=0 0 0 0]{./Media/h_thetaTau/spatialIIR_amb_N3r08.png}
            \put (12, 73.5){\tiny{$\lBrace{h\rBrace{\dTheta,\dPhi}}_{\vBrace{dB}}, r=0.8$}}
            \put (47.5, -1) {\tiny{$\dTheta/\pi$}}
            \put (-3, 38) {\tiny{$\dPhi/\pi$}}
        \end{overpic}\label{subfig_hDUDTContour_r08}}\quad
   \subfloat[][]{\begin{overpic}[width=.45\linewidth, 
        % grid, 
        tics=10,trim=0 0 0 0]{./Media/h_thetaTau/spatialIIR_amb_N3r09.png}
            \put (12, 73.5){\tiny{$\lBrace{h\rBrace{\dTheta,\dPhi}}_{\vBrace{dB}}, r=0.9$}}
            \put (47.5, -1) {\tiny{$\dTheta/\pi$}}
            \put (-3, 38) {\tiny{$\dPhi/\pi$}}
        \end{overpic}\label{subfig_hDUDTContour_r09}}
   \caption{Here we plot the general scenario array response, computed for both steer error ($\dTheta$) and phase alignment errors ($\dPhi$). Due to the $2\pi$ periodic behaviour of the response regarding $\dTheta$ and $\dPhi$, we plot the response for $-\pi<\dTheta,\dPhi<\pi$. We plot the system's response for $r = 0.4,0.6,0.8$ and $0.9$ in \ref{subfig_hDUDTContour_r04},\ref{subfig_hDUDTContour_r06},\ref{subfig_hDUDTContour_r08} and \ref{subfig_hDUDTContour_r09} respectively, and observe that as $r$ increases the spatial selectivity (regarding to both $\dTheta$ and $\dPhi$) significantly rise.}
...
% \input{./Modules/classicULA_beamwidth.tex}
