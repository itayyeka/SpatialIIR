...
% featuring high performance even in low signal-to-noise ratio, 
is presented and analyzed.
% serving as a practical and robust implementation of the feedback based localization concept. 
