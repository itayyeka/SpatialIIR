Following \eqref{eq_beamPatternFreqDomain_FIM}, we elaborate the steps leading to \eqref{eqn_FIMelements}. First, we express the partial derivatives of $\F{z}$ with respect to $\vEta$, resulting in
\begin{equation*}
