...
Inspired by time domain ``\textit{Direct form II}`` IIR filter design (see Fig.~\ref{fig_IIRBasicArch}), 
...
\begin{figure}[t!]
    \begin{center}
        ...
        tics=10,trim={0 0 0 0}]{./Media/SpatialIIR-diagram/SpatialIIR_VER7.png}
            \put (1.5, 43.5){\footnotesize{$\beta^{*}_{0}$}}
            \put (12, 43.5){\footnotesize{$\beta^{*}_{1}$}}
            \put (30, 43.5){\footnotesize{$\beta^{*}_{N-1}$}}
            \put (47, 43.5){\footnotesize{$\alpha^{*}_{0}$}}
            \put (57.5, 43.5){\footnotesize{$\alpha^{*}_{1}$}}
            \put (80, 43.5){\footnotesize{$\alpha^{*}_{N-1}$}}
