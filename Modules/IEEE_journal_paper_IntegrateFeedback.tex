...
\begin{equation}
    ...
    %}
\end{equation}
where $\vecnot{\beta}_{\text{opt}},\vecnot{\alpha}_{\text{opt}}$ are the optimal weights assuming exact knowledge of the steering vector and the phase $\phi$ (i.e. the perfect alignment scenario), 
\[
