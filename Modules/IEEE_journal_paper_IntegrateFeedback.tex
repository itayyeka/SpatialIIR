...
\begin{table}[h!]
    ...
    \resizebox{1\linewidth}{!}{
        \begin{tabular}{||c c c c||} 
            \hline
            & ULA & \thead{FEEDBACK\\BASED} & \thead{IMPROVEMENT\\for $N\gg{}1$} \\ [0.5ex] 
            \hline\hline
            HPBW & $ 1.4/N$ & $1.4/\rBrace{f(r)N}$ & $f\rBrace{r}$ times smaller\\ 
            \thead{FIRST\\SIDELOBE\\GAIN} & $2/3\pi$ & $2\rBrace{1-r}/3\pi$ & $1/\rBrace{1-r}$ times lower \\
            DIRECTIVITY & $N$ & $\rBrace{N-r}/\rBrace{1-r} & $1/\rBrace{1-r}$ time higher\\
            [1ex] 
            \hline
         \end{tabular}
     }
