...
\par Note that without feedback (i.e. setting $\vAlpha=\vecnot{0}$) the beamformed signal, $\sum_{n}x_{n,\thetaD}(t)\beta_n$, acts as the classic beamformer. 
\begin{figure}[t!]
    \begin{center}
...
\par Following previous observations, we analyze the case of $\coefSetName$ (i.e. coherently sum the array elements) using
