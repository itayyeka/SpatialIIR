...
\else
\fi
\par For standard ULA, the gain of the first sidelobe is known to be $2/3\pi$ \cite{van2004optimum}, which implies that the first sidelobe is lower by a factor of $1-r$ comparing to standard ULA.
...
\begin{table}[h!]
    ...
    \resizebox{1\linewidth}{!}{
        \begin{tabular}{||c c c c||} 
            ...
            \thead{FIRST\\SIDELOBE\\GAIN} & $2/3\pi$ & $2\rBrace{1-r}/3\pi$ & \thead{lower by a factor of $1-r$\\for $N\gg{}1$} \\
