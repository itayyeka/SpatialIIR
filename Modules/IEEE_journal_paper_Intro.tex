...
\end{equation}
The output of an $N$ element array beamformer, configured with weights $\vBeta$, is denoted as $Z\rBrace{\omega}$ and may be expressed as
...
\[
Z\rBrace{\omega} = g\F{x}_0\rBrace{\omega}\sum_{n=0}^{N-1}\beta_n
\exp\Brack{-jn\theta},
\]
