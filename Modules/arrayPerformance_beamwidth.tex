The Half-Power-Beam-Width (HPBW), denoted as $\dThetaHPBW$ quantifies the array's main lobe narrowness.
...
$$
where $\lambda$ is the signal wavelength. This result is more commonly expressed as $\dThetaHPBW/2= 1.4/N$. 
