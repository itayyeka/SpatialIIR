...
Also, the reader may notice that this setting nullifies \eqref{eqn:GeneralFeedbackTransferFunction}'s denominator which obviously causes the destabilization of the system.
